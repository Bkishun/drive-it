    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="auth-form">
          ...
          render={({ field }) => (
            <FormItem>
              <div className="shad-form-item">
                  ...
                  <FormControl>
                    <Input placeholder="johndoe@gmail.com" className="shad-input" {...field} />
                  </FormControl>
              </div>
              <FormMessage className="shad-form-message"/>
            </FormItem>
        ...
        <Button type="submit" className="form-submit-button">
          {type==='sign-in' ? 'Sign In' : 'Sign-Up' }
          {isLoading && (<Image src='/assets/icons/loader.svg' alt="loader" width={24} height={24} className="m-2 animate-spin"/>)}
        </Button>
